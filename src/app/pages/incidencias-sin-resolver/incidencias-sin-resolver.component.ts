...
@Component({
  selector: 'app-incidencias-sin-resolver',
  imports: [CommonModule, FormsModule],
  templateUrl: './incidencias-sin-resolver.component.html',
  styleUrl: './incidencias-sin-resolver.component.css'
})
export class IncidenciasSinResolverComponent {
