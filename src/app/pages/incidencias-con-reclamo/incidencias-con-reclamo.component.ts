...
@Component({
  selector: 'app-incidencias-con-reclamo',
  imports: [CommonModule, FormsModule],
  templateUrl: './incidencias-con-reclamo.component.html',
  styleUrl: './incidencias-con-reclamo.component.css'
})
export class IncidenciasConReclamoComponent {
